...
def add_safety_aead_gcm(net):
    ...
    nat0 = net.get('nat0')
    nat0.cmd("python3 mitm_detection.py &")
    
    # Avviamo il Probing
    h1 = net.get('h1')
    h1.cmd("python3 host_probing_aead.py &")
    h2 = net.get('h2')
    h2.cmd("python3 host_probing_aead.py &")
    h3 = net.get('h3')
    h3.cmd("python3 host_probing_aead.py &")
    h4 = net.get('h4')
    h4.cmd("python3 host_probing_aead.py &")
...
def add_safety_hpke(net):
    ...
    # Avviamo il Probing
    h1 = net.get('h1')
    h1.cmd("python3 host_probing_hpke.py --host h1 &")
    h2 = net.get('h2')
    h2.cmd("python3 host_probing_hpke.py --host h2 &")
    h3 = net.get('h3')
    h3.cmd("python3 host_probing_hpke.py --host h3 &")
    h4 = net.get('h4')
    h4.cmd("python3 host_probing_hpke.py --host h4 &")
