...
- **Python**:
  ...
  - *topologia.py*: classe che si occupa di avviare la topologia. L'utente in questo caso può fare due scelte:
    ...
    2. Avviare la topologia in maniera sicura facendo partire il meccanismo di proxy da parte del nat. In questo caso si possono effettuare ulteriori due scelte:
       2.1. Usare come meccanismo di crittografia del Probing AEAD_GCM con lo scambio delle chiavi realizzato con Diffie Hellman;
       2.2. Usare come meccanismo di crittografia del Probing HPKE utilizzando dunque una combinazione tra crittografia asimmetrica e crittografia simmetrica.
