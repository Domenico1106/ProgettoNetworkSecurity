...
import sys
import os
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'difesa')))
import host_probing_hpke as hpke  # viene segnalato come errore ma non lo è, funziona per il comando preceedente
